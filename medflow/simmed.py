...
def sim_med(path="", dataset_name="", cat_list=[0, 1], intv_med=None, moderator=None, quant_mod=4, model_name='models', seed=None, n_mce_samples=10000, inv_datafile_name='potential_outcome'):
